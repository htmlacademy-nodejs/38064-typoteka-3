...
describe(`API creates an article if data is valid`, () => {
  ...
  const newArticle = {
    ...
    category: [`Тестовая категория`, `IT`, `Деревья`],
